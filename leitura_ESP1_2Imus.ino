...
const char* mqtt_server = "192.168.10.196";
*/
const char* ssid = "My ASUS";
const char* password = "vitormeireles";
...
//Segunda IMU
  ...
  float aux[18]={accelx, accely, accelz, gyrox, gyroy, gyroz, magnx, magny, magnz,accelx2, accely2, accelz2, gyrox2, gyroy2, gyroz2, magnx2, magny2, magnz2};
